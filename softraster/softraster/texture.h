...
/*
 * @brief original from imgui/misc/softraster/texture.h changed to raster by
 * line
 */
...
template <typename T> INLINE_CONSTEXPR texture_type_t TextureType() {
    return texture_type_t::NONE;
}
template <> INLINE_CONSTEXPR texture_type_t TextureType<alpha8_t>() {
    return texture_type_t::ALPHA8;
}
template <> INLINE_CONSTEXPR texture_type_t TextureType<value8_t>() {
    return texture_type_t::VALUE8;
}
template <> INLINE_CONSTEXPR texture_type_t TextureType<color16_t>() {
    return texture_type_t::COLOR16;
}
template <> INLINE_CONSTEXPR texture_type_t TextureType<color24_t>() {
    return texture_type_t::COLOR24;
}
template <> INLINE_CONSTEXPR texture_type_t TextureType<color32_t>() {
...
template <typename COLOR> struct texture_t : public texture_base_t {
     ...
     */
    void (*lineWritedCb)(texture_t<COLOR> &screen, int y, const COLOR *Line, int stripeSize);
...
template <typename COLOR> COLOR texture_t<COLOR>::bad;
